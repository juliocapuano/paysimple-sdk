...
class AccountService extends Service
{
     ...
     */
    public function newCreditCard(array $credit_card)
    {
     ...
     * @throws GuzzleException
     */
    public function getCreditCard(int $account_id)
    {
        return $this->client->get("account/creditcard/{$account_id}");
    }
     ...
     * @throws GuzzleException
     */
    public function updateCreditCard(array $credit_card)
    {
     ...
     * @throws GuzzleException
     */
    public function deleteCreditCard(int $account_id)
    {
        return $this->client->delete("account/creditcard/{$account_id}");
    }
     ...
     * @throws GuzzleException
     */
    public function newAch(array $ach): array
    {
     ...
     * @throws GuzzleException
     */
    public function getAch(array $account_id)
    {
        return $this->client->get("account/ach/{$account_id}");
    }
     ...
     * @throws GuzzleException
     */
    public function updateAch(array $ach)
    {
     ...
     * @throws GuzzleException
     */
    public function deleteAch(int $account_id)
    {
        return $this->client->delete("account/ach/{$account_id}");
    }
}
